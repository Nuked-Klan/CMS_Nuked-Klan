...
define('lang_Paste_Here','Coller dans ce répertoire');
define('lang_Paste_Confirm','Eets-vous sur de vouloir coller dans ce répertoire? Cela replacera les fichiers et dossiers portant le meme nom.');
define('lang_Paste_Failed','Copie de fichiers échouées');
define('lang_Clear_Clipboard','Vider le presse-papier');
define('lang_Clear_Clipboard_Confirm','Etes-vous sur de vouloir vider le presse-papier ?');
