...
--
-- Client: localhost
-- G�n�r� le: Sam 10 Novembre 2012 � 16:57
...
(2, 1, 1, '', 'Menu', '[News]|News||0|NEWLINE[Archives]|Archives||0|NEWLINE[Forum]|Forum||0|NEWLINE[Download]|T�l�chargements||0|NEWLINE[Members]|Membres||0|NEWLINE[Team]|Team||0|NEWLINE[Defy]|Nous D�fier||0|NEWLINE[Recruit]|Recrutement||0|NEWLINE[Sections]|Articles||0|NEWLINE[Server]|Serveurs||0|NEWLINE[Links]|Liens Web||0|NEWLINE[Calendar]|Calendrier||0|NEWLINE[Gallery]|Galerie||0|NEWLINE[Wars]|Matchs||0|NEWLINE[Irc]|IrC||0|NEWLINE[Guestbook]|Livre d''Or||0|NEWLINE[Search]|Recherche||0|NEWLINE|<b>Membre</b>||1|NEWLINE[User]|Compte||1|NEWLINE|<b>Admin</b>||2|NEWLINE[Admin]|Administration||2|', 'menu', 0, 'Tous'),
...
(6, 'Mod�rateur', 1, 0, 'modules/Forum/images/rank/mod.gif'),
...
(1, 'Counter Strike Source', 'Pr�f�rences CS', 'images/games/cs.gif', 'Autre pseudo', 'Map favorite', 'Arme favorite', 'Skin Terro', 'Skin CT', 'de_dust2|de_inferno');
...
(1, '1', 'Bienvenue sur votre site NuKed-KlaN 1.7.11', 'admin', 'zbdwzpdqq76N3XirqaC0', 'Bienvenue sur votre site NuKed-KlaN, votre installation s''est, � priori, bien d�roul�e, rendez-vous dans la partie administration pour commencer � utiliser votre site tout simplement en vous loguant avec le pseudo indiqu� lors de l''install. En cas de probl�mes, veuillez le signaler sur  <a href="http://www.nuked-klan.org">http://www.nuked-klan.org</a> dans le forum pr�vu � cet effet.', '', '1352563028', 0, 0);
...
(1, 'admin', '80.236.56.247', 'Bienvenue sur votre site NuKed-KlaN 1.7.11', '1352563028');
...
(1, 'Ca d�chire, continuez !', 0, 1),
(1, 'Mouais, pas mal...', 0, 2),
(1, 'C''est naze, arr�tez-vous !', 0, 3),
...
-- Info : Reg�n�rez un nouveau pass avec la fonction mot de passe perdu.
--
