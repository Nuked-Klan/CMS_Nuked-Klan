...
--
-- Client: localhost
-- Généré le: Mer 27 Janvier 2016 à 22:33
...
(1, '1', 'Bienvenue sur votre site NuKed-KlaN 1.7.15', 'admin', 'dPM6ebzfgHQGHZfjXOcm', 'Bienvenue sur votre site NuKed-KlaN, votre installation s''est, à priori, bien déroulée, rendez-vous dans la partie administration pour commencer à utiliser votre site tout simplement en vous loguant avec le pseudo indiqué lors de l''install. En cas de problèmes, veuillez le signaler sur <a href="http://www.nuked-klan.org">http://www.nuked-klan.org</a> dans le forum prévu à cet effet.', NULL, '1453930112', 0, 0);
