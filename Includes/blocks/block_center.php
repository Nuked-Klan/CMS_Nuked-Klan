...
function affich_block_center($blok)
{
    ...
    if ($mod2 != "") {
        $blok['content'] .= "<td style=\"width: 45%;\" align=\"left\" valign=\"top\"><table width=\"100%\"><tr><td><b>" . $modname1 . "</b></td></tr><tr><td valign=\"top\">\n";
        $bid = "";
    } else {
        $blok['content'] .= "<td style=\"width: 100%;\" align=\"left\" valign=\"top\">\n";
        $bid = $blok['bid'];
    }
    ...
    if ($mod2 != "")
    {
        $blok['content'] .= "</tr></table></td><td style=\"width: 10%;\">&nbsp;</td><td style=\"width: 45%;\" align=\"left\" valign=\"top\"><table width=\"100%\"><tr><td><b>" . $modname2 . "</b></td></tr><tr><td style=\"width: 45%;\" align=\"left\" valign=\"top\">\n";
        $b = 1;
