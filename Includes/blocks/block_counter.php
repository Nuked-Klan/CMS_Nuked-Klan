...
function edit_block_counter($bid){
    ...
    echo '</select></td></tr><tr><td colspan="4" style="text-align:center;"><br />',"\n"
			...
			, '</td></tr></table>'
			, '<div style="text-align: center;"><br /><input class="button" type="submit" name="send" value="' , _MODIFBLOCK , '" /><a class="buttonLink" href="index.php?file=Admin&amp;page=block">' , _BACK , '</a></div></form><br /></div>',"\n";
}
?>