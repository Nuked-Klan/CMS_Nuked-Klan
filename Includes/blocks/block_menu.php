...
function edit_block_menu($bid){
    ...
    echo '<div class="content-box">',"\n" //<!-- Start Content Box -->
            ...
            , '<tr><td colspan="4" align="center"><br /><input class="button" type="button" value="' , _EDITMENU , '" onclick="javascript:window.location=\'index.php?file=Admin&amp;page=menu&amp;op=edit_menu&amp;bid=' , $bid , '\'" /></td></tr>',"\n"
