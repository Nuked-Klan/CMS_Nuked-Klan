...
if ($active == 3 || $active == 4)
{
    ...
    {
        echo "<form method=\"post\" onsubmit=\"maFonctionAjax(this.textbox_auteur.value,this.textbox_texte.value, this.code_confirm.value); return false;\" action=\"\" ><div style=\"text-align: center;\">\n";
	...
	else echo "<input id=\"code_confirm\" type=\"hidden\" value=\"0\" />\n";
...
else
{
    if ($visiteur >= nivo_mod("Textbox"))
    {
        ...
        echo "<input id=\"textbox_texte\" type=\"text\" name=\"texte\" size=\"25\" value=\"" . _YOURMESS . "\"  onclick=\"this.value=''\" /><br />\n";
