...
define("_UPGRADESPEED","Speed upgrade 1.7.7/1.7.8 => 1.7.9");
...
define("_ERORSQL","Management of sql errors");
define("_ERORSQL1","Whenever our C.M.S. has an error in it's SQL (database) commands, it will report them to you, to nuked-klan.org and it will send an apology to the user, instead of showing the error to the user like our old versions used to do.");
