...
define("_ERORSQL1","Whenever our C.M.S. has an error in it's SQL (database) commands, it will report them to you, to nuked-klan.eu and it will send an apology to the user, instead of showing the error to the user like our old versions used to do.");
