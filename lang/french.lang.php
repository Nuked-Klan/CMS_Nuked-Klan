...
define("_NKUPGRADE",'Mise à Jour de Nuked-Klan 1.7 vers '._NKVERSION);
define("_BADVERSION",'Votre version de Nuked-Klan ne peut pas être mise à jour en '._NKVERSION.' !');
...
define("_DECOUVERTE",'Nuked-klan '._NKVERSION.': la découverte');
...
define("_DECOUVERTE1",'Vous allez installer Nuked-Klan '._NKVERSION.', cette version orientée gamers permettra à votre team de bénéficier rapidement d\'un site web à votre image.</p><p>Vous pourrez créer une vie à votre groupe, le rassembler facilement, gérer des recrutements, des matchs ou un serveur très facilement.');
