...
function index(){
    ...
    echo "<br /><div style=\"text-align: center;\"><big><b>" . _CHANIRC . "</b></big><br /><br />\n"
            ...
            . " | <a href=\"#\" onclick=\"window.open('index.php?file=Irc&amp;op=join_chan','nom','toolbar=1,location=0,directories=0,status=0,scrollbars=0,resizable=0,copyhistory=0,menuBar=0,width=600,height=400,top=30,left=0');return(false)\" title=\"" . _CONNEXBYSITE . "\"><b>PJIRC</b></a>\n"
...
function join_chan(){
    global $user, $bgcolor2, $bgcolor3;

    nkTemplate_setPageDesign('nudePage');
    nkTemplate_setTitle(_JOINCHAN);

    echo "<form method=\"post\" action=\"index.php?file=Irc&amp;op=chat\">\n"
        ...
        . "<tr><td align=\"center\"><input type=\"submit\" value=\"" . _ENTER . "\" /></td></tr></table></td></tr></table></form>";
} 
