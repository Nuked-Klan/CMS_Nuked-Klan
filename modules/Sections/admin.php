...
if ($visiteur >= $level_admin && $level_admin > -1)
{
	...
	. "<td style=\"width: 10%;\" align=\"center\"><b>" . _DEL . "</b></td></tr>\n";
        ...
        while (list($art_id, $titre, $autor, $autor_id, $cat, $date, $parentid, $namecat) = mysql_fetch_row($sql))
        {
            ...
            . "<td style=\"width: 10%;\" align=\"center\"><a href=\"index.php?file=Sections&amp;page=admin&amp;op=edit&amp;art_id=" . $art_id . "\"><img style=\"border: 0;\" src=\"images/edit.gif\" alt=\"\" title=\"" . _EDITTHISART . "\" /></a></td>\n"
    ...
    switch ($_REQUEST['op'])
    {
        ...
        case "do_edit":
            admintop(); 
            do_edit($_REQUEST['art_id'], $_REQUEST['titre'], $_REQUEST['texte'], $_REQUEST['cat']);
            adminfoot();
            break;
