...
if ($active == 3 || $active == 4){
    ...
    echo "</td></tr><tr><td style=\"width: 45%;\" align=\"right\"><a href=\"index.php?file=Sections&amp;op=classe&amp;orderby=news\"><small>+ " . _SMORELAST . "</small></a></td>\n"
            . "<td style=\"width: 10%;\"></td><td style=\"width: 45%;\" align=\"right\"><a href=\"index.php?file=Sections&amp;op=classe&amp;orderby=count\"><small>+ " . _SMORETOP . "</small></a></td></tr></table>\n";
}
else{
    $i = 0;
