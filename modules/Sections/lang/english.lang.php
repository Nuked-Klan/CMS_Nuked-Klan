 ...
 * english.lang.php
 *
 * English translation file of Sections module
 *
 * @version     1.8
...
define('_STITLECATFORGOT', 'The title of the article category is missing');
define('_TITLEARTFORGOT', 'The title of the article is missing');
define('_TEXTARTFORGOT', 'The text of the article is missing');
...
define("_NB_ARTICLES_NO_INTEGER","Number of articles per page must be a integer.");
?>
