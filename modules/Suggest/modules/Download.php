...
function form($content, $sug_id)
{
	...
	if($_REQUEST['op'] == "show_suggest" && $content[9] != ""){$button = "<input type=\"button\" name=\"bscreen\" value=\"" . _VIEW . "\" Onclick=\"window.open('$content[9]', 'screen','width=800,height=600');\" /></input>";}
