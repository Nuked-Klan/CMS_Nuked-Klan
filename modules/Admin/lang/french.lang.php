...
define("_CLICICON","Cliquez sur une icone pour la sélectionner");
...
define("_SURDELLINE","Etes-vous certain de vouloir supprimer les lignes selectionnées ?");
...
define("_BACK","Retour");
define("_SQLSEND","Requête SQL exécuté avec succés.");
...
define("_INFOSETTING","Activer les statistiques consomment beaucoup de mémoire dans la base sql! Pensez à vider les statistiques de temps en temps depuis l\'administration.");
define("_1NBRNOTACTION","action de plus de 2 semaines a été supprimé.");
define("_NBRNOTACTION","action de plus de 2 semaines ont été supprimé.");
...
define("_STYLE", "Liste des styles prédéfini de l'éditeur");
...
define("_LISTERASED","Liste des liens morts effacé avec succès.");
define("_CHANGEEDIT", "Modification effectué avec succès.");
