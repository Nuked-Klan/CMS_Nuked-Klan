        ...
        while (false !== ($blok = readdir($handle)))
        {
            if ($blok != "." && $blok != ".." && $blok != "index.html" && $blok != "block_module.php")
            {
                if (substr($blok, -3, 3) == "php")
                {
                    ...
                    if ($blok == "survey")
                    {
                        $blokname = _NAMESURVEY;
                    }
                    else if ($blok == "menu")
                    {
                        $blokname = _NAV;
                    }
                    else if ($blok == "suggest")
                    {
                        $blokname = _NAMESUGGEST;
                    }
                    else if ($blok == "event")
                    {
                        $blokname = _NAMECALANDAR;
                    }
                    else if ($blok == "login")
                    {
                        $blokname = _LOGIN;
                    ...
                    {
                        $blokname = _CENTERBLOCK;
                    }
                    else if ($blok == "html")
                    {
                        $blokname = _BLOCKHTML;
                    }
                    else if ($blok == "language")
                    {
                        $blokname = _BLOCKLANG;
                    }
                    else if ($blok == "theme")
                    {
                        $blokname = _BLOCKTHEME;
                    }
                    else if ($blok == "counter")
                    {
                        $blokname = _BLOCKCOUNTER;
                    }
                    else
                    {
                        $blokname = $blok;
