...
function edit_config() {
    ...
    . "<div>" . _INFOSETTING . "<a href=\"index.php?file=Stats&page=admin\">" . __('STATS') . "</a>" . "</div></div></div><br/>\n"
    ...
    . "<tr><td colspan=\"2\">&nbsp;</td></tr><tr><td colspan=\"2\" align=\"center\"><big><b>" . __('STATS') . "</b></big></td></tr>\n"
