...
define("_NOTEXTMAIL","Votre message est vide !");
...
define("_FLOODCMAIL","Vous avez déja posté un email il y'a moins de " . $nuked['contact_flood'] . " minutes,<br />veuillez patienter avant de renvoyer un autre email...");
