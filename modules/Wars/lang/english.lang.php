 ...
 * english.lang.php
 *
 * English translation file of Wars module
 *
 * @version     1.8
...
define("_NB_MAP_NO_INTEGER","Number of map must be a integer.");
define("_NO_OPPONENT","The opponent of the match is missing");
define("_TEAM_SCORE_NO_INTEGER","Our score of map %d must be a integer.");
define("_TEAM_OPPONENT_NO_INTEGER","Number of map %d opponent score must be a integer.");
define("_WSPECIFY","Specify an file to be sent.");

define("_NB_MATCH_NO_INTEGER","Number of matches per page must be a integer.");
