...
?>
<html><body>
				<li><a class="shortcut-button" href="index.php?file=Gallery&amp;page=admin"><span>
					<img src="modules/Admin/images/icons/home.png" alt="icon" /><br />
					Administrer le module
				</span></a></li>
				
				<li><a class="shortcut-button" href="index.php?file=Gallery&amp;page=admin&amp;op=add_screen"><span>
					<img src="modules/Admin/images/icons/image_add_48.png" alt="icon" /><br />
					Ajouter une image
				</span></a></li>
