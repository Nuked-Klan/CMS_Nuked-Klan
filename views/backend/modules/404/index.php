...
?>
    ...
    <form method="post" action="index.php?file=Search&amp;op=mod_search">
        ...
        <p><a class="buttonLink" href="index.php?file=Search"><b><?php echo __('ADVANCED_SEARCH') ?></b></a> - <a class="buttonLink" href="javascript:history.back()"><b><?php echo __('BACK') ?></b></a></p>
    </form>
</div>
