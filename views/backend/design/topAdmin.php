...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
    <head>
        ...
        <script type="text/javascript">
            var condition_js = '<?php echo ($GLOBALS['nuked']['screen']) == 'off' ? 1 : 0 ?>';
            ...
            <div id="sidebar">
                ...
                <div id="sidebar-wrapper">
                    ...
                    <div id="profile-links">
                        <a href="index.php?file=User" title="<?php echo _EDIT ?>"><img src="<?php echo getUserAvatar() ?>" class="nkAdminUserAvatar" /></a>
                        <?php echo _BONJOUR ?>
...
<?php
    foreach ($modulesList as $module => $moduleName) :
        if ($_REQUEST['file'] == $module && $_REQUEST['page'] == 'admin') :
?>
