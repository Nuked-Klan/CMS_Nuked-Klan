...
--
-- Structure de la table `nuked_editeur`
--

DROP TABLE IF EXISTS `nuked_editeur`;
CREATE TABLE `nuked_editeur` (
  `name` varchar(255) NOT NULL DEFAULT '',
  `value` text NOT NULL,
  PRIMARY KEY (`name`)
) TYPE=MyISAM;
...
--
-- Contenu de la table `nuked_editeur`
--

INSERT INTO `nuked_editeur` (`name`, `value`) VALUES('couleur', '');
INSERT INTO `nuked_editeur` (`name`, `value`) VALUES('bouton', 'top');
INSERT INTO `nuked_editeur` (`name`, `value`) VALUES('status', 'bottom');
INSERT INTO `nuked_editeur` (`name`, `value`) VALUES('ligne1', 'save,newdocument,restoredraft,|,cut,copy,paste,pastetext,pasteword,|,undo,redo,|,print,|,fullscreen,|,preview,|,help,code');
INSERT INTO `nuked_editeur` (`name`, `value`) VALUES('ligne2', 'styleselect,fontselect,fontsizeselect,|,link,unlink,anchor,|,emotions,image,forecolor,backcolor');
INSERT INTO `nuked_editeur` (`name`, `value`) VALUES('ligne3', 'bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,hr,|,outdent,indent,|,removeformat,|,spellchecker');
INSERT INTO `nuked_editeur` (`name`, `value`) VALUES('ligne4', 'tablecontrols,|,blockquote,sub,sup,|,charmap,pagebreak');
INSERT INTO `nuked_editeur` (`name`, `value`) VALUES('ligne2b', 'styleselect,fontselect,fontsizeselect,barre,link,unlink,anchor,barre,emotions,image,forecolor,backcolor');
INSERT INTO `nuked_editeur` (`name`, `value`) VALUES('ligne3b', 'bold,italic,underline,strikethrough,barre,justifyleft,justifycenter,justifyright,justifyfull,barre,bullist,numlist,hr,barre,outdent,indent,barre,removeformat,barre,spellchecker');
INSERT INTO `nuked_editeur` (`name`, `value`) VALUES('ligne4b', 'tablecontrols,barre,blockquote,sub,sup,barre,charmap,pagebreak');
INSERT INTO `nuked_editeur` (`name`, `value`) VALUES('ligne1b', 'save,newdocument,restoredraft,barre,cut,copy,paste,pastetext,pasteword,barre,undo,redo,barre,print,barre,fullscreen,barre,preview,barre,help,code');
