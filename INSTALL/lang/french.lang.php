...
return array(
    ...
    'FIRST_NEWS_CONTENT'    => 'Bienvenue sur votre site NuKed-KlaN, votre installation s\'est, à priori, bien déroulée, rendez-vous dans la partie administration pour commencer à utiliser votre site tout simplement en vous loguant avec le pseudo indiqué lors de l\'install. En cas de problèmes, veuillez le signaler sur <a href="https://nuked-klan.fr">https://nuked-klan.fr</a> dans le forum prévu à cet effet.',
    #####################################
    ...
    'DROP_ALL_TABLE_FAILED' => 'Il y a %d tables non supprimée(s)',
    'CREATE_ALL_TABLE'      => 'Création des tables',
    'CREATE_ALL_TABLE_FAILED' => 'Il y a %d tables non crée(s)',
    'ADD_FOREIGN_KEY_ALL_TABLE' => 'Ajout des clés étrangères des tables',
    'ADD_FOREIGN_KEY_ALL_TABLE_FAILED' => 'Il y a %d table(s) sans leur(s) clé(s) étrangère(s)',
    ...
    'INSTALL_FAILED'        => 'L\'installation est terminée ! Mais des erreurs sont survenues, %d tables n\'ont pas été crée(s).',
    'UPDATE_FAILED'         => 'La mise à jour est terminée ! Mais des erreurs sont survenues, %d tables n\'ont pas été modifiée(s).',
    'PRINT_ERROR'           => ' - Erreur :',
