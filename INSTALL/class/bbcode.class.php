...
class BBcode {
     ...
     */
    public function __construct($smiliesList, $i18n) {
        $this->_smiliesList = $smiliesList;
        $this->_i18n        = $i18n;
    }
    ...
    public function apply($text) {
        if ($text != '') {
            ...
            $text = str_replace('[quote]', '<br /><table style="background: #DDD;width:100%;" cellpadding="3" cellspacing="1" border="0"><tr><td style="background: #FFF;color: #000"><div id="quote" style="border: 0; overflow: auto;"><strong>'. $this->_i18n['QUOTE'] .' :</strong><br />', $text);
            $text = preg_replace('/\[quote=(.*?)\]/i', '<br /><table style="background: #DDD;width:100%;" cellpadding="3" cellspacing="1"  border="0"><tr><td style="background: #FFF;color: #000"><div id="quote" style="border: 0; overflow: auto;"><strong>\1 '. $this->_i18n['HAS_WROTE'] .' :</strong></div>', $text);
            $text = str_replace('[/quote]', '</div></td></tr></table><br />', $text);
            $text = str_replace('[code]', '<br /><table style="background: #DDD;width:100%;" cellpadding="3" cellspacing="1" border="0"><tr><td style="background: #FFF;color: #000"><div id="code" style="border: 0; overflow: auto;"><strong>'. $this->_i18n['CODE'] .' :</strong><pre class="brush:php;">', $text);
